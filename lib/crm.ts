...
export const activityTypes = ['call', 'meeting', 'email', 'sms', 'whatsapp'] as const;
export type ActivityType = typeof activityTypes[number];
export const activityTypeLabels: Record<ActivityType, string> = { call: 'تماس', meeting: 'جلسه', email: 'ایمیل', sms: 'پیامک', whatsapp: 'واتساپ' };
